...
const IconBrandAdobeAfterEffect = createReactComponent("outline", "brand-adobe-after-effect", "BrandAdobeAfterEffect", __iconNode);

export { __iconNode, IconBrandAdobeAfterEffect as default };
